...
describe('API - Users', function() {
  ...
  it('should create new user account and allow protected fields for vnos', function( done ) {
    request(config.base)
      .post('/users')
      .type('application/vnd.api+json')
      .auth('vno', 'password')
  ...
  it('should not return confirmation_key for non-vno account', function( done ) {
    request(config.base)
  ...
  var key;
  it('should return confirmation_key when vno asks for', function( done ) {
    request(config.base)
      .get('/users/alice?fields=confirmation_key')
      .auth('vno', 'password')
      .type('application/vnd.api+json')
  ...
  it('should allow changing other passwords for vnos', function( done ) {
    request(config.base)
      .put('/users/alice')
      .auth('vno', 'password')
      .type('application/vnd.api+json')
  ...
  it('should prohibit changing enabled flag for non-vnos', function( done ) {
    request(config.base)
      .put('/users/alice')
      .auth('alice', '12345678')
      .type('application/vnd.api+json')
  ...
  it('should allow vnos to disable accounts', function( done ) {
    request(config.base)
      .put('/users/alice')
      .auth('vno', 'password')
      .type('application/vnd.api+json')
